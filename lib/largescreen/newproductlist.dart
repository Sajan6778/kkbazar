...
class NewProductListPage extends StatefulWidget {
  ...
  @override
  State<NewProductListPage> createState() => _NewProductListlargescreentate();
}

class _NewProductListlargescreentate extends State<NewProductListPage> {
      ...
      for (int id in receivedId) {
        ...
        try {
          ...
          if (response.statusCode == 200) {
            ...
            if (responseData.isNotEmpty) {
              ...
              for (var productData in datas) {
                setState(() {
                  ...
                  imageId = int.tryParse(
                          FishDataImage[0]["productVarientImagesId"] ?? '') ??
                      0;
            ...
            print(
                'Failed to fetch data for ID $id. Status code: ${response.statusCode}');
          }
        } catch (error) {
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: CircleAvatar(
                                ...
                                child: Image(
                                    image:
                                        AssetImage("images/Add to basket.png")),
                              ),
                            ),
                          ],
                        )
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          if (datas != null &&
                                            ...
                                            return InkWell(
                                              onTap: () {
                                                int selectedId = datas[index]
                                                        ['productListId'] ??
                                                    0;

                                                print(
                                                    'i am selected: $selectedId');

                                                int myproductId =
                                                    datas[index]['productId'];
                                                print(
                                                    "productId send : $myproductId");
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                    builder: (context) =>
