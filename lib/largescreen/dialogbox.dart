...
import 'package:responsive/largescreen/Addresspage.dart';
...
class ProductDetail1 extends StatefulWidget {
  ...
  ProductDetail1(
      {super.key, required this.detailListId, required this.sendingProductId});
...
class _ProductDetail1State extends State<ProductDetail1> {
  ...
  Future<void> getData(receivedId) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
          ...
          setState(() {
            ...
            if (responseData.isNotEmpty) {
              ...
              if (productListId != null) {
                ...
                print(
                    'Invalid productListId format: ${responseData[0]['productListId']}');
              }
            } else {
        ...
        print(
            'Failed to fetch datas for ID $receivedId. Status code: ${response.statusCode}');
      }
    } catch (error) {
          ...
          if (ourresponseData.isNotEmpty) {
            for (var categoryData in ourresponseData) {
              ...
              if (productListId != null) {
                ...
                print(
                    'Invalid productListId format: ${ourresponseData[0]['productListId']}');
              }
            }
          } else {
  ...
  Future<void> getDataProduct() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to fetch data for Product ID $receivedIdProduct. Status code: ${response.statusCode}');
      }
    } catch (error) {
  ...
  Future<void> _fetchDataProduct() async {
    ...
    print(
        'All Product data fetched'); // This will be printed after all data is fetched
  }
                    ...
                    children: [
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            productListIdValue =
                                ourresponseData[0]["productListId"];
                            productVarientImagesId =
                                datas[index]['productVarientImagesId'];
                              ...
                              onTap: () {
                                setState(() {
                                  if (datas != null &&
                                    ...
                                    largeImageUrl = Constants.ipBaseUrl +
                                        datas[index][
                                            'productVarientImageUrl']; // Set a default image if there's no image available
                                  }
                                });
                              },
                              child: InkWell(
                      ...
                      Container(
                          ...
                          child: largeImageUrl.isNotEmpty
                              ...
                              : Image.network(
                                  Constants.ipBaseUrl +
                                      datas[0]['productVarientImageUrl'],
                                  width: 468,
                                  height: 480,
                                  fit: BoxFit.cover,
                                )
                                  ...
                                  children: [
                                    InkWell(
                                      onTap: () async {
                                        ...
                                        if (isAuthenticated) {
                                          print(
                                              "productListIdValue:$productListIdValue");
                                          print(
                                              "productVarientImagesId:$productVarientImagesId");
                                          postCart(productListIdValue,
                                              productVarientImagesId);
                                ...
                                Expanded(
                                  child: ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      var varientImages =
                                          productList['varientImages'];

                                      if (varientImages != null &&
                                          varientImages.isNotEmpty) {
                                        return GestureDetector(
                                          onTap: () {
                                            int productListId =
                                                ...
                                                onTap: () {
                                                  dynamic receivedId =
                                                      productList[
                                                          'productListId'];
                                                  print(
                                                      "varient images list id is:$receivedId");
                                                  getOrderDetail(receivedId);
                                                  largeImageUrl = Constants
                                                          .ipBaseUrl +
                                                      varientImages[0][
                                                          'productVarientImageUrl'];
                                                },
