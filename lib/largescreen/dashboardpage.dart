...
import 'package:responsive/largescreen/Aboutus.dart';
import 'package:responsive/largescreen/Login.dart';
import 'package:responsive/largescreen/faqpage.dart';
import 'package:responsive/largescreen/pdf%20file.dart';
import 'package:responsive/largescreen/privacypolicy.dart';
...
import 'package:responsive/largescreen/wishlist_page.dart';
...
class _MyScrollableColumnState extends State<MyScrollableColumn>
  ...
  void getData() async {
    final Uri url = Uri.parse(Constants.ipBaseUrl +
        'category?CategoryImage=CategoryDetail'); // Replace with your endpoint
  ...
  void getDataCarosal2() async {
    final Uri url = Uri.parse(Constants.ipBaseUrl +
        'carousel/view?carousel=carouselDetails'); // Replace with your endpoint
  ...
  void getDataMobile() async {
    final Uri url = Uri.parse(Constants.ipBaseUrl +
        'dashboard1/view?dashboard=dashboardActiveDetails'); // Replace with your endpoint
  ...
  void getDataFish() async {
    final Uri url = Uri.parse(
        Constants.ipBaseUrl + 'dashboard2/view?dashboard=dashboardDetails');
  ...
  void getDataProducts() async {
    final Uri url = Uri.parse(
        Constants.ipBaseUrl + 'product/category/view?category=categoryDetails');
                    ...
                    Row(
                      children: [
                        ...
                        InkWell(
                          ...
                          child:CircleAvatar(radius: 30,child: Image.asset(
                            "images/Heart.png",
                  ...
                  children: [
                                ...
                                child: Center(
                                  child: DropdownButton<String>(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      print(
                                          "Selected categoryId: ${selectedCategory.categoryId}");
                                      ...
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              NewProductListPage(carosalcatid: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          SizedBox(width: 20.0),
                          CircleAvatar(radius: 20,child:Image.asset("images/Online support.png") ,),
                    ...
                    Container(
                      ...
                      child: Expanded(
                        child: PageView.builder(
                          ...
                          itemCount:
                              (responseData.length / itemsPerPage).ceil(),
                          itemBuilder: (BuildContext context, int index) {
                            int startIndex = index * itemsPerPage;
                            int endIndex = startIndex + itemsPerPage;
                            endIndex = endIndex < responseData.length
                                ? endIndex
                                : responseData.length;
                            ...
                            for (int i = startIndex; i < endIndex; i++) {
                              responseData.isEmpty
                                  ...
                                  : pageItems.add(
                                      InkWell(
                                        onTap: () {
                                          if (carosalcatid3 != null &&
                                              carosalcatid3.isNotEmpty) {
                                            print(
                                                "carosalcatid=$carosalcatid3");
                        ...
                        responseData.isEmpty
                            ...
                            : pageItems.add(
                                Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      if (carosalcatid1 != null &&
                                          carosalcatid1.isNotEmpty) {
                        ...
                        child: Container(
                          ...
                          child: FishData.isEmpty
                              ...
                              : PageView.builder(
                                  ...
                                  itemCount: (totalItemsfish / itemsPerPagefish)
                                      .ceil(),
                                  itemBuilder:
                                      (BuildContext context, int index) {
                                    int startIndex = index * itemsPerPagefish;
                                    int endIndex =
                                        (index + 1) * itemsPerPagefish;
                                    endIndex = endIndex < FishData.length
                                        ? endIndex
                                        : FishData.length;
                                        ...
                                        if (FishData.isNotEmpty &&
                                          ...
                                          final productPrice =
                                              (product['totalAmount'] ?? 0)
                                                  .toString();
                                          final productMrp =
                                              (product['mrp'] ?? 0).toString();

                                          int myproductId =
                                              product['productId'];
                                          print(
                                              " fish productId send : $myproductId");

                                          int productListIdfish =
                                              product['productListId'] ?? 0;

                                          int selectedId = productListIdfish;
                                          print('i am selected: $selectedId');

                                          dynamic productVarientImagesIdFish =
                                              product['productVarientImagesId'];
                                          print(
                                              "productVarientImagesIdFish:$productVarientImagesIdFish");

                                          final productDisPerc =
                                              (product['discountPercentage'] ??
                                                      0)
                                                  .toString();
                                          final averageStarRate =
                                              (product['averageStarRate'] ?? 0);
                                          return GestureDetector(
                                            onTap: () {
                                              if (selectedId != null) {
                                                print(
                                                    "i am send : $myproductId");
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (isAuthenticated) {
                                                          setState(() {
                                                            ...
                                                            productListIdValue =
                                                                selectedId;
                                                            varientImagesIdValue =
                                                                productVarientImagesIdFish;
                                                            print(
                                                                "varientImagesIdValue fish:$varientImagesIdValue");
                                                            postWishlist();
                                                          });
                                                        } else {
                                                          Navigator.push(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      if (responseProductData != null) {
                        productDetails =
                            responseProductData[index]['productDetails'];
                        print("productDetails:$productDetails");
                        productDetails1 =
                            productDetails[index]['productListDetails'];
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      if (productDetails != null) {
                                        final productName =
                                            productDetails[index1]
                                                        ["productListDetails"]
                                                    [0]['productName'] ??
                                                '';

                                        final proImages = productDetails[index1]
                                                    ["productListDetails"][0]
                                                ["productVarientImagesList"][0]
                                            ['productVarientImageUrl'];

                                        final productPrice = (productDetails[
                                                            index1]
                                                        ["productListDetails"]
                                                    [0]['totalAmount'] ??
                                                0)
                                        ...
                                        final productMrp = (productDetails[
                                                            index1]
                                                        ["productListDetails"]
                                                    [0]['mrp'] ??
                                                0)
                                            .toString();
                                        final productUnit = (productDetails[
                                                            index1]
                                                        ["productListDetails"]
                                                    [0]['unit'] ??
                                                0)
                                        ...
                                        itemWishlistStatus =
                                            productDetails[index1]
                                                ...
                                                false;
                                        print(
                                            "itemWishlistStatus:$itemWishlistStatus");
                                        final averageStarRate =
                                            productDetails[index1]
                                                        ["productListDetails"]
                                                    [0]['averageStarRate'] ??
                                        ...
                                        print(
                                            'product List Id Values: $detailListId');
                                        int selectedId = detailListId[0];
                                        print('selectedId: $selectedId');

                                        List<int> ListIdValues1 = [];
                                        int productID1 = productDetails[index1]
                                                    ["productListDetails"][0]
                                                ['productId'] ??
                                            0;
                                        ...
                                        print(
                                            ' category wise product Id Values: $detailListId1');
                                        ...
                                        dynamic VarientImagesId_AllDatas =
                                            productDetails[index1][
                                                        "productListDetails"][0]
                                                    ["productVarientImagesList"]
                                                [0]['productVarientImagesId'];
                                        print(
                                            "productVarientImagesId_data:$VarientImagesId_AllDatas");
                                        ...
                                        return GestureDetector(
                                          onTap: () {
                                            if (selectedId != null) {
                                              print(
                                                  "category based product List Id=$selectedId");
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                              "Weight :",
                                                                              style: TextStyle(fontSize: 9.544021606445312, color: Color(0xffEF8F21))),
                                                                          Text(
                                                                              (productUnit ?? 0).toString(),
                                                                              style: TextStyle(fontSize: 9.544021606445312, color: Color(0xffEF8F21))),
                                                                        ],
                                                                      ),
                                                                    ),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text("MRP:",
                                                                                style: TextStyle(decoration: TextDecoration.lineThrough, fontSize: 12, color: Color(0xff717171))),
                                                                            Text((productMrp).toString(),
                                                                                // meat_list[i]
                                                                                // ["mrp"]!,
                                                                                style: TextStyle(decoration: TextDecoration.lineThrough, fontSize: 12, color: Color(0xff717171))),
                                                                          ],
                                                      ...
                                                      if (isAuthenticated) {
                                                        ...
                                                        setState(() {
                                                          ...
                                                          productListIdValue1 =
                                                              selectedId;
                                                          print(
                                                              "productListIdValue1=$productListIdValue1");
                                                          varientImagesIdValue1 =
                                                              VarientImagesId_AllDatas;
                                                          print(
                                                              "data__varientImagesIdValue1:$varientImagesIdValue1");
                                                          postWishlist1();
                                                        });
                                                      } else {
                                                        Navigator.push(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          ...
                          child: new Text("Sorry please try again tomorrow",
                              style: TextStyle(
  ...
  Widget buildRatingCard1(int index, double rating) {
    ...
    return Row(
      children: [
        ...
        if (fractionalStarValue > 0) FractionalStar(fractionalStarValue),
        SizedBox(width: 10),
        Text(
          '$rating',
