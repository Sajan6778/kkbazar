...
class _NewAddressState extends State<BuyNowQty> {
  ...
  void _saveValuesInSharedPreferences(double totalCardAmount, double cardprice,
      int productListId, int quantity, int index) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  void updateTotalPrice() {
    setState(() {
      totalPrice = pricevalue != null
          ? pricevalue! * counters[currentQuantityIndex]
          : null;
    });
  }
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          _saveValuesInSharedPreferences(pricevalue, totalPrice,
                              productlistId, counters[currentQuantityIndex], 0);
