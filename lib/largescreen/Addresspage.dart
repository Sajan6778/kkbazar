...
import 'package:responsive/largescreen/Cartpage.dart';
import 'package:responsive/largescreen/payment.dart';
...
class _MyScrollableColumnState extends State<MyScrollableColumn> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<AddressManager>(builder: (context, addressManager, _) {
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              radius: 20,
                              child: Image.asset("images/Online support.png"),
                            ),
                            SizedBox(width: 20.0),
                            Text("+00 123 456 789",
                                style: TextStyle(
                                                ...
                                                children: [
                                                  Text("Total Ammount payable",
                                                      style: TextStyle(
                                                          ...
                                                          color: Colors.black)),
                                                  Text(
                                                      "₹${retrievedTotalAmount.toStringAsFixed(2)} ",
                                                      style: TextStyle(
                                                          fontSize: 22,
                                                          color: Colors.black))
                                                ],
                                        ...
                                        Row(
                                          children: [
                                            Consumer<AddressManager>(
                                              builder:
                                                  (context, addressManager, _) {
                                                return Radio(
                                                  value: AddressType.home,
                                                  groupValue: addressManager
                                                      .selectedAddressType,
